...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->test-steeltoe]
...
┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'test-steeltoe.csproj'
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->test-steeltoe, sample-app->weatherforecast-stee...(truncated)]
